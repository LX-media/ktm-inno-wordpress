...
?>
	...
	<?php ob_start(); ?>
		<header id="main-header" data-height-onload="<?php echo esc_attr( et_get_option( 'menu_height', '66' ) ); ?>">
			<div class="LxHeader clearfix et_menu_container">
			<?php
			...
			?>
				<div class="logo_container">
					<a href="<?php echo esc_url( home_url( '/' ) ); ?>">
						<img src="<?php echo esc_attr( $logo ); ?>" alt="<?php echo esc_attr( get_bloginfo( 'name' ) ); ?>" id="LxLogo" data-height-percentage="<?php echo esc_attr( et_get_option( 'logo_height', '54' ) ); ?>" />
						<img src="/wp-content/themes/ktm-innovation/assets/img/ktm-innovation-logo-inv.png" alt="<?php echo esc_attr( get_bloginfo( 'name' ) ); ?>" id="LxLogoInverted" data-height-percentage="<?php echo esc_attr( et_get_option( 'logo_height', '54' ) ); ?>" />

					</a>
				</div>
				<div class="LxBurger"> 
					<span class="LxBOne"></span>
					<span class="LxBTwo"></span>
				</div>
			...
			<div id="LxMenu" class="main-menu">
				<div class="LxMenuContainer">
					<div class="LxColumn">
					<?php if ( is_active_sidebar( 'custom-menu-left' ) ) : ?>
						<div id="menu-widget-area" class="" role="complementary">
						<?php dynamic_sidebar( 'custom-menu-left' ); ?> 
						</div>
					<?php endif; ?>
					</div>
					<div class="LxColumn"> 
					<?php if ( is_active_sidebar( 'custom-menu-middle' ) ) : ?>
						<div id="menu-widget-area" class="" role="complementary">
						<?php dynamic_sidebar( 'custom-menu-middle' ); ?> 
						</div>
					<?php endif; ?>
					</div>
					<div class="LxColumn"> 
					<?php if ( is_active_sidebar( 'custom-menu-right' ) ) : ?>
						<div id="menu-widget-area" class="" role="complementary">
						<?php dynamic_sidebar( 'custom-menu-right' ); ?> 
						</div>
					<?php endif; ?>
					</div>
				</div>
